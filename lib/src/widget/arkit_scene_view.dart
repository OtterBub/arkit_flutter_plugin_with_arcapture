...
class ARKitController {
  ...
  static const _rectConverter = RectConverter();
  ...
  Future<ImageProvider> snapshot({double? compressionQuality}) async {
    final result = await _channel.invokeMethod<Uint8List>(
        'snapshot', {"compressionQuality": compressionQuality});
  ...
  Future<Rect?> getContentViewRect() async {
    final result =
        await _channel.invokeMapMethod<String, double>('getContentViewRect');
    final Rect? cvtResult = _rectConverter.fromJson(result!);
